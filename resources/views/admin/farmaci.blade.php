...
<head>
    ...
    <meta charset="UTF-8"/>
    <title>PillMate Admin — Farmaci</title>
...
<main class="main">
    <div class="page-header">
        <div>
            <h1>Catalogo Farmaci</h1>
            <p>Aggiungi e gestisci i farmaci disponibili per le terapie</p>
        </div>
    ...
    <div style="display:grid;grid-template-columns:360px 1fr;gap:24px;align-items:start;">
        ...
        <div class="card">
            <div class="card-title">
                ...
                Farmaci nel catalogo ({{ $farmaci->total() }})
            </div>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    @forelse($farmaci as $f)
                        <tr>
                            ...
                            <span style="font-family:'Syne',sans-serif;font-weight:700;">
                                {{ $f->terapie_count ?? \App\Models\Terapia::where('id_farmaco',$f->id)->count() }}
                            </span>
                            </td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6">
                                <div class="empty-state">Nessun farmaco nel catalogo. Aggiungine uno.</div>
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
