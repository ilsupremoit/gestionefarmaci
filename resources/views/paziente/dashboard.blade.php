...
<head>
    ...
    <title>PillMate — Dashboard Paziente</title>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .avatar{width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,var(--green),var(--accent2));display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700}
...
<aside class="sidebar">
    ...
    <a class="nav-item" href="#"><span class="ico">💊</span> Le mie terapie</a>
    <a class="nav-item" href="#"><span class="ico">📋</span> Storico assunzioni</a>
...
<main class="main">
    <div class="page-header">
        ...
        <p>Il tuo piano terapeutico — {{ now()->format('d/m/Y') }}</p>
    </div>
    <div class="stats">
        <div class="stat-card">
        ...
        <div class="stat-card">
            <div class="stat-top"><span class="stat-label">Dosi oggi</span><div class="stat-ico green">✅</div></div>
            <div class="stat-value">0</div>
            <div class="stat-sub">da assumere</div>
        </div>
        <div class="stat-card">
    ...
    <div class="content-grid">
        <div class="card">
            <div class="card-title">💊 Prossime assunzioni</div>
