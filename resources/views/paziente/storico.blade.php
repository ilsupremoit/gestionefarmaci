    ...
    <div class="stats storico-stats">
        <div class="stat-card">
            <div class="stat-top">
                ...
                <div class="stat-ico blue"><i data-lucide="chart-column"></i></div>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-top">
                <span class="stat-label">Dosi prese</span>
                <div class="stat-ico green"><i data-lucide="check-circle-2"></i></div>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-top">
                <span class="stat-label">Aderenza globale</span>
                <div class="stat-ico teal"><i data-lucide="chart-line"></i></div>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-top">
                <span class="stat-label">Forzate dal medico</span>
                <div class="stat-ico yellow"><i data-lucide="unlock"></i></div>
            </div>
                        ...
                        <tr class="clickable-row" onclick="window.location='{{ route('paziente.assunzione.show', $a->id) }}'">
                            ...
                            <td style="font-size:12px;color:var(--muted);">
                                ...
                                @if($a->apertura_forzata)
                                    <br><span style="color:var(--accent);font-size:10px;display:inline-flex;align-items:center;gap:4px;"><i data-lucide="unlock" style="width:11px;height:11px;"></i> Forzata medico</span>
                                @endif
                            </td>
                            ...
                            <td><span style="color:var(--accent);font-size:13px;"><i data-lucide="arrow-right" style="width:14px;height:14px;"></i></span></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
