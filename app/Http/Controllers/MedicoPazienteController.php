...
class MedicoPazienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'comune_nascita' => ['required', 'string', 'max:100'],
            'codice_fiscale' => ['required', 'string', 'size:16', 'unique:pazienti,codice_fiscale'],
            ...
            'sesso.required'          => 'Il sesso è obbligatorio (necessario per il CF).',
            'data_nascita.required'   => 'La data di nascita è obbligatoria.',
            'comune_nascita.required' => 'Il comune di nascita è obbligatorio (necessario per il CF).',
            'codice_fiscale.required' => 'Il codice fiscale è obbligatorio.',
            'codice_fiscale.size'     => 'Il codice fiscale deve essere di esattamente 16 caratteri.',
